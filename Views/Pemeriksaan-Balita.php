   ...
   <body>
    <div class="login-container">
        <div class="login-header">
            <h1>TAMBAH DATA CHECK-UP BALITA</h1>
        </div>
        
        <form class="login-form" action="" method="post">
            <div class="input-group">
                <input type="text" id="username" placeholder="Kode" name="username">
            </div>
            ...
            <div class="input-group">
                <input type="gender" id="gender" placeholder="Nik" name="gender">
            </div>
            ...
            <div class="input-group">
            <label for="birthday">Tanggal Periksa</label>
                <input type="date" id="birthday" name="birthday">
            </div>

            <div class="input-group">
                <input type="weight" id="weight" placeholder="Jenis Kelamin" name="weight">
            </div>
